...
/*
 * Совмещает слова строк str_1 и str_2, записывая их в строку str_mixed, беря
 * по очереди по одному слову из строк str_1 и str_2. Если слова в одной из
 * строк закончились раньше, чем во второй, то осуществляет копирование
 * оставшихся слов в результирующую строку str_mixed. Не сохраняет пробельные
 * символы бывшие между словами в строках str_1 и str_2, в качестве
 * разделителя слов в результирующей строке используется символ пробела
 */
